...
class BloxorzSuite extends FunSuite {
  ...
  test("neighbors") {
    new Level1 {
      val sBlock = Block(Pos(1, 1), Pos(1, 1))
      ...
      assert(sBlock.neighbors == List((leftBlock, Left), (rightBlock, Right), (upBlock, Up), (downBlock, Down)))
      assert(sBlock.legalNeighbors == List((rightBlock, Right), (downBlock, Down)))
    }
  }
